...
values(lunch_code, '포크칠리', 'm1_l1.gif',4500,'돈까스와 떡갈비에 탕수육까지 환상의 조합으로
 ...
 insert  into lunch(LUNCH_CODE, LUNCH_NAME, IMG, PRICE, SPEC, ID)
values(lunch_code, '돈까스', 'm1_l2.gif',3800,'누구나 좋아하는 돈까스!, SPEC
...
values(order_code, 1, '김정윤', '010-3456-4567','211.63.89.133', 'L_000001');

insert into ordering( ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code, 3, '공선의', '010-2412-8514','211.63.89.157', 'L_000001');

insert into ordering( ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code, 1, '이재현', '010-1231-4231','211.63.89.135', 'L_000002');
commit;
